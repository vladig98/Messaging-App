...
namespace MessagingApp.Migrations
{
    ...
    [Migration("20240410190858_fixingUserPassword")]
    partial class fixingUserPassword
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MessagingApp.Models.Role", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MessagingApp.Models.Chat", b =>
                {
                    b.HasOne("MessagingApp.Models.User", "Receiver")
                        .WithMany("ReceiverChats")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("MessagingApp.Models.User", "Sender")
            ...
            modelBuilder.Entity("MessagingApp.Models.User", b =>
                {
                    b.HasOne("MessagingApp.Models.Role", "Role")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("MessagingApp.Models.Role", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
